                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Insert Daily Report - {{$machine->op_no}}</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <form action="{{ route('historicalStatus') }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <div class="row mb-4">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="category" id="problem" class="form-control">
